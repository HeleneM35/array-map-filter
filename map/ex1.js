...
function getStringsLength(foodStrings) {

   const foodLength = foodStrings.length

   return food.map((foodStrings) => (`${foodStrings} contains ${foodLength} characters`))
 }
...
// console.log(`${foodStrings} contains ${length} characters`)
